package ru.geekbrains.homework6_log_test;

import java.util.Arrays;

public class ArrayHomework {
    public static void main(String[] args) {
        System.out.println(Arrays.toString(sliceArray(new int[]{8, 6, 3, 2, 2, 4, 5, 11, 12, 3})));
        System.out.println(hasOneAndFour(new int[] {1,4,4,1,4,4,1,4,1,4,1}));
